...
include("include/sidebar.php"); ?>          
 <?php
   if(isset($_REQUEST['upid']) && $_REQUEST['upid']!=''){
	  $dovalue="editcameraman";
	  $doid=$_REQUEST['upid'];
	  $upuserresult=mysqli_query($con,"select * from cameraman where id='".$_REQUEST['upid']."'");
	  $upuserarr=mysqli_fetch_array($upuserresult);
  }else{
 	  $dovalue="addcameraman";
	  $doid='';
	  }
?>     
                                    ...
                                    <form method="post"  class="" enctype="multipart/form-data" action="action.php"  role="form">
                                       ...
                                       <input type="hidden"  name="do" value="<?php echo $dovalue;?>" />
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="name" required  placeholder="Customer Name" value="<?php if(isset($_REQUEST['upid'])){ echo $upuserarr['name'];}?>">
                                        </div>
                                        <div class="form-group">
                                          <label>Address</label>
