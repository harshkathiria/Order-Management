...
include("include/sidebar.php"); ?>          
 <?php
   if(isset($_REQUEST['upid']) && $_REQUEST['upid']!=''){
	  $dovalue="editBookingcameraman";
	  $doid=$_REQUEST['upid'];
	  $upuserresult=mysqli_query($con,"select * from booking_cameraman where id='".$_REQUEST['upid']."'");
	  $upfetch=mysqli_fetch_array($upuserresult);
  }else{
 	  $dovalue="addBookingcameraman";
	  $doid='';
	  }
?>     
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Booking CameraMan </li>
                    </ol>
              </section>
